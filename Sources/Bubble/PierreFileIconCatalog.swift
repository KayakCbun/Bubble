...
enum PierreFileIconCatalog {
    ...
    static let nameTokens: [String: String] = [
        ".babelrc": "babel",
        ".babelrc.json": "babel",
        ".bash_profile": "bash",
        ".bashrc": "bash",
    ...
    static let extraNameSymbols: [String: String] = [
    ...
    static let extensionTokens: [String: String] = [
        "7z": "zip",
        "astro": "astro",
        "AUTHORS": "text",
        "avif": "image",
    ...
    static let completeOverrides: [String: String] = [
        "jsx": "react",
        "sass": "sass",
        "scss": "sass",
        "tsx": "react"
    ...
    static let lightColors: [String: String] = [
        "astro": "A631BE",
        "babel": "D5A910",
        "bash": "199F43",
        "biome": "1A85D4",
